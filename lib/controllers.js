...
exports.halving = function($){
  client.get('https://blockchain.info/stats?format=json', (data, response) => {
    var currentBlock = data.n_blocks_total,
        blocksLeft = 420000 - currentBlock,
        minutesBetween = data.minutes_between_blocks,
        minutesLeft = blocksLeft * minutesBetween,
        hoursLeft = minutesLeft / 60,
        daysLeft = hoursLeft / 24;

    $.sendMessage("Blocks Remaining Until Halving: " + blocksLeft + "\nApprox Minutes Until Halving: " + minutesLeft + "\nApprox Hours Until Halving: " + hoursLeft + "\nApprox Days Until Halving: " + daysLeft);
  });
}
