...
exports.halving = function($){
  client.get('https://blockchain.info/stats?format=json', (data, response) => {
    var currentBlock = data.n_blocks_total,
        ...
        hoursLeft = blocksLeft * 60,
        daysLeft = blocksLeft * 24;
        //daysLeft = daysLeft - 1;

    $.sendMessage("Los bloques restantes hasta el Halving: " + blocksLeft + "\nTiempo aproximado para el halving: " + daysLeft.toFixed(0) + ":" + hoursLeft.toFixed(0) + ":" + minutesLeft.toFixed(0));
  });
}
